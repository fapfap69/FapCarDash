...
function DateTime() {
    ...
    if(localize=='it'){
    	this.weekdays = new Array('Domenica', 'Lunedi', 'Martedi', 'Mercoledi', 'Giovedi', 'Venerdi', 'Sabato');
    ...
    this.formats = {
        ...
        constants: {
            ...
            dayLong: this.sym.d.dddd + ", " + this.sym.d.dd + " " + this.sym.d.mmmm + " " + this.sym.d.yyyy 
        },
        pretty: {
